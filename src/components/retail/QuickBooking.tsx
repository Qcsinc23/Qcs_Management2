...
import { Alert, Autocomplete, Box, Button, Checkbox, CircularProgress, FormControlLabel, Grid, Paper, Step, StepLabel, Stepper, TextField, Typography } from '@mui/material'
...
function convertToFormData(booking: Partial<BookingDetails>): Partial<BookingFormData> {
  if (!booking)
    return {}
  return {
    ...booking,
...
function convertToBookingData(formData: BookingFormData): Partial<BookingDetails> {
  return {
    ...formData,
    package: {
      ...formData.package,
      weight: Number.parseFloat(formData.package.weight),
    },
  }
}
